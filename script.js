...
document.querySelector('.stewie-pic').addEventListener('click', function() { characterBuyProcessor(event, stewie); });

document.querySelector('.peter-pic').addEventListener('click', function() { characterBuyProcessor(event, peter); });

document.querySelector('.cleveland-pic').addEventListener('click', function() { characterBuyProcessor(event, cleveland); });

document.querySelector('.wp-default-pic').addEventListener('click', function() { backgroundBuyProcessor(event, wp_default) });

document.querySelector('.wp-krichev-pic').addEventListener('click', function() { backgroundBuyProcessor(event, wp_krichev) });

document.querySelector('.wp-tehran-pic').addEventListener('click', function() { backgroundBuyProcessor(event, wp_tehran) });